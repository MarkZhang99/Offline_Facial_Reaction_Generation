...
class ReactionDataset(data.Dataset):
    ...
    def __init__(self, root_path, split, img_size=256, crop_size=224, clip_length=751, fps=25,audio_dim=78, _3dmm_dim=58, emotion_dim=25,
        ...
        self._video_path = os.path.join(self._data_path, 'Video_frames')
